...
/// Device settings editor showing device info, pet stats, and configuration.
///
/// Provides inline editing for device name, pet name, and full config parameters
/// including numeric fields and persist-flag toggles. Ported from the web app's
/// Device.tsx page.
...
/// Horizontal stat bar showing a label, numeric value, and colored progress indicator.
...
/// Numeric input field for device configuration values.
...
/// Toggle for a single persist flag within a `PersistFlags` option set.
